(function (t) {
    ...
    var o = t.document, r = [];
    e.isReady = !1, "function" == typeof define && define.amd ? (e.isReady = "function" == typeof requirejs, define(["eventie/eventie"], n)) : "object" == typeof exports ? module.exports = n(require("eventie")) : t.docReady = n(t.eventie)
}(window), function (t) {
    "use strict";
    function e(t) {
        if (t) {
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var y = o.paddingLeft + o.paddingRight, g = o.paddingTop + o.paddingBottom, v = o.marginLeft + o.marginRight, b = o.marginTop + o.marginBottom, E = o.borderLeftWidth + o.borderRightWidth, w = o.borderTopWidth + o.borderBottomWidth, S = c && u, L = e(n.width);
                L !== !1 && (o.width = L + (S ? 0 : y + E));
                var x = e(n.height);
                return x !== !1 && (o.height = x + (S ? 0 : g + w)), o.innerWidth = o.width - (y + E), o.innerHeight = o.height - (g + w), o.outerWidth = o.width + v, o.outerHeight = o.height + b, o
            }
        }
        function a(t, e) {
            if (o || -1 === e.indexOf("%"))
    ...
    function o(t, o, r) {
        ...
        var u = r("transition"), h = r("transform"), c = u && h, p = !!r("perspective"), d = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend", transition: "transitionend"}[u], l = ["transform", "transition", "transitionDuration", "transitionProperty"], f = function () {
        ...
        a.prototype._transitionTo = function (t, e) {
            ...
            a = c.isOriginLeft ? a : -a, u = c.isOriginTop ? u : -u, h.transform = m(a, u), this.transition({to: h, onTransitionEnd: {transform: this.layoutPosition}, isCleaning: !0})
    ...
    function s(i, s, p, l, f, m) {
        ...
        var g = 0, v = {};
        return y.namespace = "outlayer", y.Item = m, y.defaults = {containerStyle: {position: "relative"}, isInitLayout: !0, isOriginLeft: !0, isOriginTop: !0, isResizeBound: !0, isResizingContainer: !0, transitionDuration: "0.4s", hiddenStyle: {opacity: 0, transform: "scale(0.001)"}, visibleStyle: {opacity: 1, transform: "scale(1)"}}, e(y.prototype, p.prototype), y.prototype.option = function (t) {
            e(this.options, t)
            ...
            for (var e = this.options.itemSelector, i = [], o = 0, r = t.length; r > o; o++) {
                ...
                if (d(s))
                    if (e) {
                        f(s, e) && i.push(s);
                        for (var a = s.querySelectorAll(e), u = 0, h = a.length; h > u; u++)
                            i.push(a[u])
                    } else
                        i.push(s)
            }
    ...
    function e(t, e) {
        ...
        return n.prototype._resetLayout = function () {
            ...
            for (var r = this._getColGroup(o), s = Math.min.apply(Math, r), a = i(r, s), u = {x: this.columnWidth * a, y: s}, h = s + t.size.outerHeight, c = this.cols + 1 - r.length, p = 0; c > p; p++)
                this.colYs[a + p] = h;
            return u
            ...
            for (var u = (this.options.isOriginTop ? n.top : n.bottom) + i.outerHeight, h = s; a >= h; h++)
    ...
    "use strict";
    var e = t.MD, i = getStyleProperty("transition"), n = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "otransitionend", transition: "transitionend"}[i];
    e.faq = function () {
        (function () {
            ...
            var t = document.querySelector("#animate-item-size-responsive .masonry"), e = new Masonry(t, {columnWidth: ".grid-sizer", itemSelector: ".item"});
            eventie.bind(t, "click", function (t) {
                var o = t.target;
    ...
    s.index = function () {
        (function () {
            ...
            n = t.querySelector(".hero-masonry"), o = new Masonry(n, {itemSelector: ".hero-item", columnWidth: ".grid-sizer"}), e()
        })(), r = document.querySelector("#load-more-examples")
    };
    var a = [{title: "Card", url: "http://erikjohanssonphoto.com/work/imagecats/personal/", image: "rakuten.png"}, {title: "Beyoncé | I Am", url: "http://iam.beyonce.com/", image: "http://i.imgur.com/HDSAMFl.jpg"}]
}(window), function (t) {
    "use strict";
    function e() {
    ...
    i.methods = function () {
        (function () {
            ...
            var t = document.querySelector("#stamp-demo"), e = t.querySelector(".stamp"), i = t.querySelector("button"), n = new Masonry(t.querySelector(".masonry"), {columnWidth: 60, itemSelector: ".item"}), o = !1;
            eventie.bind(i, "click", function () {
