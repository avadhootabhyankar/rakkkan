...
function ThumbnailSlider(f) {
    var g = "length", i = "className", T = function (a, c) {
        ...
        return a[c]
    }, q = "largeImageSlider", s = "appendChild", E = "inSyncWithLargeImageSlider", t = function (d) {
        var a = d.childNodes, c = [];
        if (a)
            for (var b = 0, e = a[g]; b < e; b++)
    ...
    }, h = "style", k = "offsetTop", m = "offsetLeft", v = "offsetHeight", C = "offsetWidth", y = "onmouseover", x = "onmouseout", B = function () {
        this.b = [];
        this.c = null;
        this.d()
    };
    ...
    var W = M() < 9, H = M() < 8, O = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    B.a = {g: function (a) {
    ...
    B.prototype = {k: {b: f.scrollDuration, a: function () {
            }, e: B.a.g, d: 1}, d: function () {
            ...
            if (a) {
                ...
                if (this.supportAnimationFrame)
                    window.cancelAnimationFrame(this.c);
                else
    ...
    var a = {a: 0, b: 0, c: 0, d: 0, e: 1, f: 0}, j, b, d, n, e, c, D, p, A, l, o, r, z, w, u = function () {
        ...
        b = {a: f.license, b: f.scrollInterval, c: f.autoAdvance, d: f.scrollByEachThumb, e: f.circular, Ob: function () {
        ...
        p && p.c()
    }, V = document, X = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/], J = function (b) {
    ...
    P.prototype = {b: function () {
            ...
            G.b = [];
            o = null;
            a = {a: 0, b: 0, c: 0, d: 0, e: 1, f: 0};
            if (!j)
                n[h].height = e[h].height
        }, c: function () {
            var c = this.n();
            if (c[0]) {
                if (o == null)
            ...
            if (f[q]) {
                ...
                f[E] && f[q].getAuto() && f[q].changeOptions({autoAdvance: false})
            }
        }, d: function () {
            a.c = 0;
            u();
            ...
            b.Ob.call(this, a.a);
            var i = Math.abs(e - g);
            G.r(c, h, e, g, {b: f.scrollDuration, a: r, e: B.a.j, d: i > 500 ? 1.5 : i > 240 ? 1.2 : 1});
            ...
            if (!b.d) {
                var f = h, i = t(c);
                while (true) {
                    if (j && d[f][m] - d[a.a][m] > e[C])
                        break;
                    else if (!j && d[f][k] - d[a.a][k] > e[v])
                        break;
                    if (f == i[i[g] - 1].i)
                        break;
                    h = f;
            ...
            for (var e = t(c), b = 0, f = e[g]; b < f; b++)
                if (e[b].i == a.a)
                    ...
                    c[s](e[b]);
            if (j)
                c[h].left = l - d[a.a][m] + "px";
            else if (H)
                c[h].top = l - d[a.a][k] + "px";
            else
                c[h].top = -d[a.a][k] + "px"
        }, n: function () {
            return(new Function("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", function (c) {
                for (var b = [], a = 0, d = c[g]; a < d; a++)
                    b[b[g]] = String.fromCharCode(c.charCodeAt(a) - 4);
                return b.join("")
            ...
            if (b.e) {
                var i = t(c), n = i[i[g] - 1].i;
                if (!b.d)
                    for (var f = i[g] - 1; f > -1; f--) {
                        if (j && D - i[f][m] > e[C])
                            break;
                        else if (!j && D - i[f][k] > e[v])
                            break;
                        n = i[f].i
                    }
                for (var f = i[g] - 1; f > -1; f--) {
                ...
                if (!b.d)
                    for (var f = n; f > -1; f--) {
                        if (j && d[a.a][m] - d[f][m] > e[C] || !j && d[a.a][k] - d[f][k] > e[v])
                            break;
                        n = d[f].i
                    }
            }
