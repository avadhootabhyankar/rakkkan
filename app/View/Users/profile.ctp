...
function makeExampleItem( dataObj ) {
  ...
  return item;
   ...
   <body class="index-page" data-page="index" style="padding-bottom:0px;background:white;">
        ...
        <!-- /.row -->
            <hr>
                    ...
                    <div class="row text-center mystyle">
                        <div id="hero">
                            <div class="primary-content" style="border-top: none;margin-left: 240px;width:900px;">
